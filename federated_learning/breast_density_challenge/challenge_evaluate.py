...
def compute_metrics(args):
    ...
    gt = []
    if args.gt1:
        gt.append(read_ground_truth(args.gt1))
    if args.gt2:
        gt.append(read_ground_truth(args.gt2))
    if args.gt3:
        gt.append(read_ground_truth(args.gt3))
    ground_truth = pd.concat(gt)
...
def main():
    ...
    parser.add_argument(
        "--gt1", type=str, default=None
    )
    parser.add_argument(
        "--gt2", type=str, default=None
    )
    parser.add_argument(
        "--gt3", type=str, default=None
    )
    parser.add_argument(
        "--pred",
        type=str,
    ...
    parser.add_argument("--site_names", type=str, default="site-1,site-2,site-3")
